...
### Features
- **dht:** /dht + /dht.json — the content layer the connected nodes know about (#24)

## [0.18.0] - 2026-08-02

### Features
- **dashboard:** Serve /health on the traffic port so the LB check can move there (#23)

## [0.17.0] - 2026-08-02

### Features
- **proxy-protocol:** Recover each peer's real source address behind the TLS NLB (#22)

## [0.16.1] - 2026-08-01

### Bug Fixes
- **deploy:** Re-mint OIDC credentials after the image build so the ECS roll can authenticate (#21)

## [0.16.0] - 2026-08-01

### Features
- **service:** Scope-explicit install/uninstall/start/stop (#526) (#20)

## [0.15.1] - 2026-07-30

### Bug Fixes
- **map:** Locate a peer by its first LOCATABLE address, not merely its first (#19)
...
### Bug Fixes
- **release:** Sync Cargo.lock to package version + enforce --locked in CI (#18)
